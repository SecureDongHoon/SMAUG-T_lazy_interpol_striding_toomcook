# SMAUG-T_lazy_interpol_striding_toomcook
Apply lazy interpolation and cache access optimization techniques to hybrid Toom-Cook polynomial multiplication (Toom-Cook-4-way + 2-level Karatsuba) of SMAUG-T
